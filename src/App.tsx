  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-100 p-6 flex flex-col items-center">
        <form onSubmit={handleSubmit} className="mb-6 w-full max-w-xl flex gap-2">
          <select
            value={selectedMood}
          ...
          <input
            ...
            className="flex-1 p-2 rounded border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
          />
          <button
            type="submit"
